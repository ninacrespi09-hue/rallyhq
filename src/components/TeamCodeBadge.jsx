  ...
  return (
    <div className="absolute right-5 top-5 z-10 sm:right-8 sm:top-8">
      <button
        ...
        className="rounded-md bg-white/85 px-3 py-2 text-right shadow-soft ring-1 ring-blue-100/80 backdrop-blur transition hover:bg-white"
      >
        <div className="text-[10px] font-bold uppercase tracking-wide text-navy-400">Team code</div>
        <div className="font-mono text-sm font-semibold tracking-wider text-brand-600">{code}</div>
        {teamName && <div className="mt-0.5 max-w-[140px] truncate text-[10px] text-navy-500">{teamName}</div>}
        <div className="mt-1 text-[10px] font-semibold text-blue-500">
